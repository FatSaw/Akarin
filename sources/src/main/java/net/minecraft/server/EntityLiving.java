...
public abstract class EntityLiving extends Entity {
    ...
    public void Y() {
        ...
        if (this.isAlive()) {
            if (ticksLived % 10 == 0 && couldPossiblyBeHurt(1.0F) && this.inBlock()) { // Dionysus - optimize suffocation
    ...
    protected void cI() {
        if (this.isHandRaised()) {
            ...
            if (itemstack == this.activeItem) {
                ...
                boolean shouldLagCompensate = this.activeItem.asBukkitMirror().getType().isEdible() && this.eatStartTime != -1 && (System.nanoTime() - this.eatStartTime) > ((1 + this.totalEatTimeTicks) * 50 * (1000 * 1000));
